...
### 赋值要求：例如：jdCookie|ql|JD_DailyBonus&sendNotify@JDHelloWorld|ccwav
###                jdCookie|ql|JD_DailyBonus                   三个脚本均不屏蔽仓库文件夹复制替换
###                sendNotify@JDHelloWorld|ccwav               不复制到 JDHelloWorld 和 ccwav 的仓库文件夹
js_deps_replace_envs="jdCookie|ql|JD_DailyBonus&sendNotify@JDHelloWorld|ccwav"   
